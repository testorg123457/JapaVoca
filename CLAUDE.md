...
톤: 단단하고 절제된 라운드(버튼 12 / 카드 16 / 시트 24). 과한 둥글림(둥글둥글·pill 남발)과 완전 직각 둘 다 지양. 부드러움은 라운드가 아니라 그림자·여백·위계로 낸다.
...
MVP: 로그인·온보딩, 단어/한자 4지선다(SRS), 캐시상자·개봉광고, 지갑·내역, 기프티콘 교환, SSV·정합성·어뷰징 방어.
(출석·연속출석은 2026-07-31에 범위에서 제외 — 기능 제거됨)
