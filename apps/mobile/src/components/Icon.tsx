    ...
    <Svg width={size} height={size} viewBox="0 0 24 24">
      {(() => {
        switch (name) {
          ...
          case 'bell':
            // 종 몸통(위 곡선 → 아래로 퍼지는 어깨) + 클래퍼. 바닥을 평평한 사다리꼴로
            // 두면 뭉툭해 보여서, 어깨를 완만한 곡선으로 흘려 형태를 정리했다.
            return (
              <>
                <Path
                  d="M18 10.2 a6 6 0 1 0 -12 0 c0 4.2-1.1 5.6-2 6.5 a0.7 0.7 0 0 0 0.5 1.2 h15 a0.7 0.7 0 0 0 0.5-1.2 c-0.9-0.9-2-2.3-2-6.5z"
                  {...s}
                />
                <Path d="M10.1 20.3 a2.1 2.1 0 0 0 3.8 0" {...s} />
              </>
            );
          case 'lock':
            return (
